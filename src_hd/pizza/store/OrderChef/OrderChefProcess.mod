[Ivy]
[>Created: Thu Dec 15 16:39:49 ICT 2022]
184F07D83728581A 3.18 #module
>Proto >Proto Collection #zClass
Os0 OrderChefProcess Big #zClass
Os0 RD #cInfo
Os0 #process
...
>Proto Os0 Os0 OrderChefProcess #zField
Os0 f0 guid 184F07D8388896F5 #txt
Os0 f0 type pizza.store.OrderChef.OrderChefData #txt
...
out.dataOrdered = OrderClient.getOrders(StringUtils.EMPTY, StatusOrder.CONFIRMED);' #txt
...
Os0 f1 type pizza.store.OrderChef.OrderChefData #txt
Os0 f1 211 51 26 26 0 12 #rect
Os0 f1 @|RichDialogProcessEndIcon #fIcon
Os0 f2 expr out #txt
Os0 f2 109 64 211 64 #arcP
Os0 f3 guid 184F07D83978AD3E #txt
Os0 f3 type pizza.store.OrderChef.OrderChefData #txt
Os0 f3 actionDecl 'pizza.store.OrderChef.OrderChefData out;
' #txt
...
Os0 f4 type pizza.store.OrderChef.OrderChefData #txt
Os0 f4 guid 184F07D8398CB9D5 #txt
Os0 f4 211 147 26 26 0 12 #rect
Os0 f4 @|RichDialogEndIcon #fIcon
Os0 f5 expr out #txt
Os0 f5 109 160 211 160 #arcP
Os0 f6 guid 1850AB0A308FE5A2 #txt
Os0 f6 type pizza.store.OrderChef.OrderChefData #txt
...
import pizza.store.service.OrderService;
//OrderService.changeStatusOrder(param.orderId, StatusOrder.COOKED);
//out.dataOrdered = OrderService.getOrders();
OrderClient.updateStatusOrder(param.orderId,StatusOrder.COOKED);
out.dataOrdered = OrderClient.getOrders(StringUtils.EMPTY, StatusOrder.CONFIRMED);' #txt
...
Os0 f7 type pizza.store.OrderChef.OrderChefData #txt
Os0 f7 307 243 26 26 0 12 #rect
Os0 f7 @|RichDialogProcessEndIcon #fIcon
Os0 f8 expr out #txt
Os0 f8 109 256 307 256 #arcP
Os0 f9 guid 18515267BA4EB3D5 #txt
Os0 f9 type pizza.store.OrderChef.OrderChefData #txt
...
out.dataOrdered = OrderClient.getOrders(out.nameSearch,pizza.store.StatusOrder.CONFIRMED);' #txt
...
' #txt
Os0 f9 83 323 26 26 -23 15 #rect
Os0 f9 @|RichDialogMethodStartIcon #fIcon
Os0 f10 type pizza.store.OrderChef.OrderChefData #txt
Os0 f10 275 323 26 26 0 12 #rect
Os0 f10 @|RichDialogProcessEndIcon #fIcon
Os0 f11 expr out #txt
Os0 f11 109 336 275 336 #arcP
>Proto Os0 .type pizza.store.OrderChef.OrderChefData #txt
